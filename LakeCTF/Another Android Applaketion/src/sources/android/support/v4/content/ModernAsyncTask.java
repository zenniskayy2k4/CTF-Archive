...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    static {
        ThreadFactory threadFactory = new ThreadFactory() { // from class: android.support.v4.content.ModernAsyncTask.1
    ...
    ModernAsyncTask() {
        WorkerRunnable<Params, Result> workerRunnable = new WorkerRunnable<Params, Result>() { // from class: android.support.v4.content.ModernAsyncTask.2
        ...
        this.mFuture = new FutureTask<Result>(workerRunnable) { // from class: android.support.v4.content.ModernAsyncTask.3
