...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    */
    void moveToState(android.support.v4.app.Fragment r17, int r18, int r19, int r20, boolean r21) throws java.lang.NoSuchFieldException, android.content.res.Resources.NotFoundException {
        /*
    ...
    private void animateRemoveFragment(final Fragment fragment, AnimationOrAnimator animationOrAnimator, int i) throws NoSuchFieldException {
    ...
    void completeShowHideFragment(final Fragment fragment) throws NoSuchFieldException, Resources.NotFoundException {
        if (fragment.mView != null) {
    ...
    private static class AnimateOnHWLayerIfNeededListener extends AnimationListenerWrapper {
        ...
        @Override // android.support.v4.app.FragmentManagerImpl.AnimationListenerWrapper, android.view.animation.Animation.AnimationListener
        public void onAnimationEnd(Animation animation) {
            ViewCompat.isAttachedToWindow(this.mView);
