...
public class NotificationCompat {
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            for (Message message : this.mMessages) {
                ...
                Notification.MessagingStyle.Message message2 = new Notification.MessagingStyle.Message(message.getText(), message.getTimestamp(), person == null ? null : person.toAndroidPerson());
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            ...
            if (!z || this.mBuilder.mActions == null || (iMin = Math.min(this.mBuilder.mActions.size(), 3)) <= 0) {
                ...
                for (int i2 = 0; i2 < iMin; i2++) {
                    remoteViewsApplyStandardTemplate.addView(R.id.actions, generateActionButton(this.mBuilder.mActions.get(i2)));
                }
            }
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        return new Action(action.icon, action.title, action.actionIntent, action.getExtras(), remoteInputArr, null, action.getExtras().getBoolean("android.support.allowGeneratedReplies") || action.getAllowGeneratedReplies(), action.getSemanticAction(), action.getExtras().getBoolean("android.support.action.showsUserInterface", true));
    }
