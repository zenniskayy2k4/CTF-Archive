...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
            ...
            if (eventType == 2) {
                ...
                if (ANIMATED_VECTOR.equals(name)) {
                    ...
                    if (resourceId != 0) {
                        ...
                        vectorDrawableCompatCreate.setAllowCaching(DBG_ANIMATION_VECTOR_DRAWABLE);
    ...
    public static boolean unregisterAnimationCallback(Drawable drawable, Animatable2Compat.AnimationCallback animationCallback) {
        return (drawable == null || animationCallback == null || !(drawable instanceof Animatable)) ? DBG_ANIMATION_VECTOR_DRAWABLE : unregisterPlatformCallback((AnimatedVectorDrawable) drawable, animationCallback);
    }
