...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    private static final boolean IS_PRE_LOLLIPOP = DEBUG;
    ...
    private final Runnable mInvalidatePanelMenuRunnable = new Runnable() { // from class: android.support.v7.app.AppCompatDelegateImpl.2
        ...
        public void run() {
            ...
            AppCompatDelegateImpl.this.mInvalidatePanelMenuPosted = AppCompatDelegateImpl.DEBUG;
    ...
    static class AnonymousClass1 implements Thread.UncaughtExceptionHandler {
        ...
        private boolean shouldWrapException(Throwable th) {
            ...
            if (!(th instanceof Resources.NotFoundException) || (message = th.getMessage()) == null) {
                return AppCompatDelegateImpl.DEBUG;
            }
    ...
    public void onStop() {
        ActionBar supportActionBar = getSupportActionBar();
        if (supportActionBar != null) {
            supportActionBar.setShowHideAnimationEnabled(DEBUG);
        }
    ...
    private void ensureSubDecor() {
        ...
        PanelFeatureState panelState = getPanelState(0, DEBUG);
    ...
    private ViewGroup createSubDecor() throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        if (typedArrayObtainStyledAttributes.getBoolean(android.support.v7.appcompat.R.styleable.AppCompatTheme_windowNoTitle, DEBUG)) {
            requestWindowFeature(1);
        } else if (typedArrayObtainStyledAttributes.getBoolean(android.support.v7.appcompat.R.styleable.AppCompatTheme_windowActionBar, DEBUG)) {
            requestWindowFeature(AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR);
        }
        if (typedArrayObtainStyledAttributes.getBoolean(android.support.v7.appcompat.R.styleable.AppCompatTheme_windowActionBarOverlay, DEBUG)) {
            requestWindowFeature(AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR_OVERLAY);
        }
        if (typedArrayObtainStyledAttributes.getBoolean(android.support.v7.appcompat.R.styleable.AppCompatTheme_windowActionModeOverlay, DEBUG)) {
            requestWindowFeature(10);
        }
        this.mIsFloating = typedArrayObtainStyledAttributes.getBoolean(android.support.v7.appcompat.R.styleable.AppCompatTheme_android_windowIsFloating, DEBUG);
        typedArrayObtainStyledAttributes.recycle();
        ...
        if (!this.mWindowNoTitle) {
            if (this.mIsFloating) {
                ...
                this.mOverlayActionBar = DEBUG;
                this.mHasActionBar = DEBUG;
                ...
                viewGroup = (ViewGroup) LayoutInflater.from(contextThemeWrapper).inflate(android.support.v7.appcompat.R.layout.abc_screen_toolbar, (ViewGroup) null);
    ...
    void onPanelClosed(int i) {
        if (i == 108) {
            ActionBar supportActionBar = getSupportActionBar();
            if (supportActionBar != null) {
                supportActionBar.dispatchMenuVisibilityChanged(DEBUG);
                return;
            }
            return;
        }
    ...
    public boolean onMenuItemSelected(MenuBuilder menuBuilder, MenuItem menuItem) {
        ...
        return (windowCallback == null || this.mIsDestroyed || (panelFeatureStateFindMenuPanel = findMenuPanel(menuBuilder.getRootMenu())) == null) ? DEBUG : windowCallback.onMenuItemSelected(panelFeatureStateFindMenuPanel.featureId, menuItem);
    }
        ...
        if (actionModeOnWindowStartingSupportActionMode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    PopupWindow popupWindow = new PopupWindow(contextThemeWrapper, (AttributeSet) null, android.support.v7.appcompat.R.attr.actionModePopupWindowStyle);
    ...
    public View createView(View view, String str, Context context, AttributeSet attributeSet) {
        ...
        boolean zShouldInheritContext = DEBUG;
    ...
    private void openPanel(PanelFeatureState panelFeatureState, KeyEvent keyEvent) {
        ...
        if (windowManager != null && preparePanel(panelFeatureState, keyEvent)) {
            if (panelFeatureState.decorView == null || panelFeatureState.refreshDecorView) {
                ...
                panelFeatureState.isHandled = DEBUG;
    ...
    private boolean preparePanel(PanelFeatureState panelFeatureState, KeyEvent keyEvent) {
        ...
        if (panelFeatureState2 != null && panelFeatureState2 != panelFeatureState) {
            closePanel(panelFeatureState2, DEBUG);
        }
        Window.Callback windowCallback = getWindowCallback();
        ...
        if (panelFeatureState.createdPanelView == null && (!z || !(peekSupportActionBar() instanceof ToolbarActionBar))) {
            if (panelFeatureState.menu == null || panelFeatureState.refreshMenuContent) {
                ...
                panelFeatureState.refreshMenuContent = DEBUG;
            }
            panelFeatureState.menu.stopDispatchingItemsChanged();
    ...
    void closePanel(PanelFeatureState panelFeatureState, boolean z) {
        ...
        panelFeatureState.isPrepared = DEBUG;
        panelFeatureState.isHandled = DEBUG;
        panelFeatureState.isOpen = DEBUG;
    ...
    private boolean onKeyDownPanel(int i, KeyEvent keyEvent) {
        ...
        PanelFeatureState panelState = getPanelState(i, true);
        return !panelState.isOpen ? preparePanel(panelState, keyEvent) : DEBUG;
    }
    ...
    */
    ...
    private boolean performPanelShortcut(PanelFeatureState panelFeatureState, int i, KeyEvent keyEvent, int i2) {
        boolean zIsSystem = keyEvent.isSystem();
        boolean zPerformShortcut = DEBUG;
        if (zIsSystem) {
            return DEBUG;
        }
    ...
    void doInvalidatePanelMenu(int i) {
        ...
        panelState2.refreshDecorView = true;
        if ((i != 108 && i != 0) || this.mDecorContentParent == null || (panelState = getPanelState(0, DEBUG)) == null) {
            return;
        }
        panelState.isPrepared = DEBUG;
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (marginLayoutParams.topMargin != (rect2.top == 0 ? i : 0)) {
                    ...
                    if (view == null) {
                        ...
                        view2.setBackgroundColor(this.mContext.getResources().getColor(android.support.v7.appcompat.R.color.abc_input_method_navigation_guard));
    ...
    public boolean applyDayNight() {
        ...
        boolean zUpdateForNightMode = iMapNightMode != -1 ? updateForNightMode(iMapNightMode) : DEBUG;
        if (nightMode == 0) {
    ...
    private final class PanelMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public void onCloseMenu(MenuBuilder menuBuilder, boolean z) {
            ...
            boolean z2 = rootMenu != menuBuilder ? true : AppCompatDelegateImpl.DEBUG;
            AppCompatDelegateImpl appCompatDelegateImpl = AppCompatDelegateImpl.this;
            if (z2) {
    ...
    protected static final class PanelFeatureState {
        ...
        boolean refreshDecorView = AppCompatDelegateImpl.DEBUG;
        ...
        MenuView getListMenuView(MenuPresenter.Callback callback) {
            ...
            if (this.listMenuPresenter == null) {
                ListMenuPresenter listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, android.support.v7.appcompat.R.layout.abc_list_menu_item_layout);
        ...
        private static class SavedState implements Parcelable {
            ...
            static SavedState readFromParcel(Parcel parcel, ClassLoader classLoader) {
                ...
                boolean z = parcel.readInt() != 1 ? AppCompatDelegateImpl.DEBUG : true;
                savedState.isOpen = z;
                if (z) {
    ...
    class AppCompatWindowCallback extends WindowCallbackWrapper {
        ...
        public boolean onCreatePanelMenu(int i, Menu menu) {
            return (i != 0 || (menu instanceof MenuBuilder)) ? super.onCreatePanelMenu(i, menu) : AppCompatDelegateImpl.DEBUG;
        }
        ...
        public boolean onPreparePanel(int i, View view, Menu menu) {
            ...
            if (menuBuilder != null) {
                menuBuilder.setOverrideVisibleItems(AppCompatDelegateImpl.DEBUG);
            }
    ...
    private class ActionBarDrawableToggleImpl implements ActionBarDrawerToggle.Delegate {
        ...
        public Drawable getThemeUpIndicator() {
            TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(getActionBarThemedContext(), (AttributeSet) null, new int[]{android.support.v7.appcompat.R.attr.homeAsUpIndicator});
