...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private void init(View view) {
        ...
        if (typedArrayObtainStyledAttributes.getBoolean(android.support.v7.appcompat.R.styleable.ActionBar_hideOnContentScroll, $assertionsDisabled)) {
    ...
    public void setCustomView(int i) {
        setCustomView(LayoutInflater.from(getThemedContext()).inflate(i, this.mDecorToolbar.getViewGroup(), $assertionsDisabled));
    }
    ...
    private void hideForActionMode() {
        if (this.mShowingForMode) {
            ...
            ActionBarOverlayLayout actionBarOverlayLayout = this.mOverlayLayout;
            if (actionBarOverlayLayout != null) {
                actionBarOverlayLayout.setShowingForActionMode($assertionsDisabled);
            }
            updateVisibility($assertionsDisabled);
        }
    }
    ...
    public class ActionModeImpl extends ActionMode implements MenuBuilder.Callback {
        ...
        public boolean onMenuItemSelected(MenuBuilder menuBuilder, MenuItem menuItem) {
            ...
            return callback != null ? callback.onActionItemClicked(this, menuItem) : WindowDecorActionBar.$assertionsDisabled;
        }
