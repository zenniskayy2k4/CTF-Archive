    ...
    public boolean flagActionItems() {
        ...
        while (i10 < size) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                if (actionMenuPresenter.mStrictWidthLimit) {
                    iMeasureChildForCells -= ActionMenuView.measureChildForCells(itemView, i, iMeasureChildForCells, iMakeMeasureSpec, r2);
                } else {
                ...
                if (z4) {
                    ...
                    z4 = z5 & (!actionMenuPresenter.mStrictWidthLimit ? i4 + i11 <= 0 : i4 < 0);
                } else {
                    i2 = size;
                }
                if (z4 && groupId2 != 0) {
