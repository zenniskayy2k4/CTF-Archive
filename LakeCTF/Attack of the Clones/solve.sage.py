...
_sage_const_3329 = Integer(3329); _sage_const_512 = Integer(512); _sage_const_4 = Integer(4); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_1665 = Integer(1665); _sage_const_2 = Integer(2); _sage_const_8 = Integer(8)
import json
import numpy as np
    ...
    for row_idx in range(n):
        ...
        for j in range(k): # For each r[j]
            ...
            for coef_idx, coef_val in enumerate(a):
                ...
                sign = _sage_const_1 
                if target_pos < _sage_const_0 :
                    target_pos += n
                    sign = -_sage_const_1  # Negacyclic property x^n = -1
...
limit_low = _sage_const_1665  // _sage_const_2 
limit_high = (_sage_const_1665  + _sage_const_3329 ) // _sage_const_2 
...
for i in range(_sage_const_0 , len(bits), _sage_const_8 ):
    byte = bits[i:i+_sage_const_8 ]
    val = int("".join(map(str, byte)), _sage_const_2 )
