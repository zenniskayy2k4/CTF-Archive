...
extern int crypto_auth_hmacsha512256_tweet(unsigned char *,
                                           const unsigned char *,
                                           unsigned long long,
                                           const unsigned char *);
...
#define crypto_auth_hmacsha512256_KEYBYTES                                     \
  crypto_auth_hmacsha512256_tweet_KEYBYTES
#define crypto_auth_hmacsha512256_VERSION                                      \
  crypto_auth_hmacsha512256_tweet_VERSION
#define crypto_auth_hmacsha512256_IMPLEMENTATION                               \
  "crypto_auth/hmacsha512256/tweet"
...
#define crypto_box_IMPLEMENTATION                                              \
  crypto_box_curve25519xsalsa20poly1305_IMPLEMENTATION
...
extern int crypto_box_curve25519xsalsa20poly1305_tweet(
    unsigned char *, const unsigned char *, unsigned long long,
    const unsigned char *, const unsigned char *, const unsigned char *);
extern int crypto_box_curve25519xsalsa20poly1305_tweet_open(
    unsigned char *, const unsigned char *, unsigned long long,
    const unsigned char *, const unsigned char *, const unsigned char *);
extern int crypto_box_curve25519xsalsa20poly1305_tweet_keypair(unsigned char *,
                                                               unsigned char *);
extern int crypto_box_curve25519xsalsa20poly1305_tweet_beforenm(
    unsigned char *, const unsigned char *, const unsigned char *);
extern int crypto_box_curve25519xsalsa20poly1305_tweet_afternm(
    unsigned char *, const unsigned char *, unsigned long long,
    const unsigned char *, const unsigned char *);
extern int crypto_box_curve25519xsalsa20poly1305_tweet_open_afternm(
    unsigned char *, const unsigned char *, unsigned long long,
    const unsigned char *, const unsigned char *);
#define crypto_box_curve25519xsalsa20poly1305_tweet_VERSION "-"
#define crypto_box_curve25519xsalsa20poly1305                                  \
...
#define crypto_box_curve25519xsalsa20poly1305_beforenm                         \
  crypto_box_curve25519xsalsa20poly1305_tweet_beforenm
#define crypto_box_curve25519xsalsa20poly1305_afternm                          \
...
#define crypto_box_curve25519xsalsa20poly1305_SECRETKEYBYTES                   \
  crypto_box_curve25519xsalsa20poly1305_tweet_SECRETKEYBYTES
#define crypto_box_curve25519xsalsa20poly1305_BEFORENMBYTES                    \
  crypto_box_curve25519xsalsa20poly1305_tweet_BEFORENMBYTES
#define crypto_box_curve25519xsalsa20poly1305_NONCEBYTES                       \
  crypto_box_curve25519xsalsa20poly1305_tweet_NONCEBYTES
#define crypto_box_curve25519xsalsa20poly1305_ZEROBYTES                        \
  crypto_box_curve25519xsalsa20poly1305_tweet_ZEROBYTES
#define crypto_box_curve25519xsalsa20poly1305_BOXZEROBYTES                     \
  crypto_box_curve25519xsalsa20poly1305_tweet_BOXZEROBYTES
#define crypto_box_curve25519xsalsa20poly1305_VERSION                          \
  crypto_box_curve25519xsalsa20poly1305_tweet_VERSION
#define crypto_box_curve25519xsalsa20poly1305_IMPLEMENTATION                   \
...
extern int crypto_hashblocks_sha512_tweet(unsigned char *,
                                          const unsigned char *,
                                          unsigned long long);
#define crypto_hashblocks_sha512_tweet_VERSION "-"
#define crypto_hashblocks_sha512 crypto_hashblocks_sha512_tweet
#define crypto_hashblocks_sha512_STATEBYTES                                    \
  crypto_hashblocks_sha512_tweet_STATEBYTES
#define crypto_hashblocks_sha512_BLOCKBYTES                                    \
  crypto_hashblocks_sha512_tweet_BLOCKBYTES
...
extern int crypto_hashblocks_sha256_tweet(unsigned char *,
                                          const unsigned char *,
                                          unsigned long long);
...
#define crypto_hashblocks_sha256_STATEBYTES                                    \
  crypto_hashblocks_sha256_tweet_STATEBYTES
#define crypto_hashblocks_sha256_BLOCKBYTES                                    \
  crypto_hashblocks_sha256_tweet_BLOCKBYTES
...
extern int crypto_hash_sha512_tweet(unsigned char *, const unsigned char *,
                                    unsigned long long);
...
extern int crypto_hash_sha256_tweet(unsigned char *, const unsigned char *,
                                    unsigned long long);
...
extern int crypto_onetimeauth_poly1305_tweet(unsigned char *,
                                             const unsigned char *,
                                             unsigned long long,
                                             const unsigned char *);
...
#define crypto_onetimeauth_poly1305_KEYBYTES                                   \
  crypto_onetimeauth_poly1305_tweet_KEYBYTES
#define crypto_onetimeauth_poly1305_VERSION                                    \
  crypto_onetimeauth_poly1305_tweet_VERSION
#define crypto_onetimeauth_poly1305_IMPLEMENTATION                             \
...
extern int crypto_scalarmult_curve25519_tweet(unsigned char *,
                                              const unsigned char *,
                                              const unsigned char *);
extern int crypto_scalarmult_curve25519_tweet_base(unsigned char *,
                                                   const unsigned char *);
...
extern int crypto_secretbox_xsalsa20poly1305_tweet(unsigned char *,
                                                   const unsigned char *,
                                                   unsigned long long,
                                                   const unsigned char *,
                                                   const unsigned char *);
...
#define crypto_secretbox_xsalsa20poly1305                                      \
  crypto_secretbox_xsalsa20poly1305_tweet
#define crypto_secretbox_xsalsa20poly1305_open                                 \
...
#define crypto_secretbox_xsalsa20poly1305_IMPLEMENTATION                       \
  "crypto_secretbox/xsalsa20poly1305/tweet"
...
extern int crypto_stream_xsalsa20_tweet(unsigned char *, unsigned long long,
                                        const unsigned char *,
                                        const unsigned char *);
extern int crypto_stream_xsalsa20_tweet_xor(unsigned char *,
                                            const unsigned char *,
                                            unsigned long long,
                                            const unsigned char *,
                                            const unsigned char *);
...
#define crypto_stream_xsalsa20_NONCEBYTES                                      \
  crypto_stream_xsalsa20_tweet_NONCEBYTES
...
extern int crypto_stream_salsa20_tweet(unsigned char *, unsigned long long,
                                       const unsigned char *,
                                       const unsigned char *);
extern int crypto_stream_salsa20_tweet_xor(unsigned char *,
                                           const unsigned char *,
                                           unsigned long long,
                                           const unsigned char *,
                                           const unsigned char *);
...
void ed25519_pk_from_sk(unsigned char outpk[32], const unsigned char sk64[64]);
#endif
