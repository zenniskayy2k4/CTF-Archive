...
namespace System.IO.Hashing
{
	public sealed class Crc32 : NonCryptographicHashAlgorithm
	{
		...
		private static ReadOnlySpan<uint> CrcLookup
		{
			get
			{
				object obj = global::_003CPrivateImplementationDetails_003E._12F3E0576D447EB37B36D82BA0C1C5481B8F0D12FDC70347CE4A076B229D4C86_A14;
				if (obj == null)
				{
					obj = new uint[256]
					{
					...
					global::_003CPrivateImplementationDetails_003E._12F3E0576D447EB37B36D82BA0C1C5481B8F0D12FDC70347CE4A076B229D4C86_A14 = (uint[])obj;
				}
		...
		public static byte[] Hash(ReadOnlySpan<byte> source)
		{
			...
			BinaryPrimitives.WriteUInt32LittleEndian(value: HashToUInt32(source), destination: array);
			return array;
		}
		...
		public static bool TryHash(ReadOnlySpan<byte> source, Span<byte> destination, out int bytesWritten)
		{
			...
			uint value = HashToUInt32(source);
		...
		{
			return ~Update(uint.MaxValue, source);
		}
